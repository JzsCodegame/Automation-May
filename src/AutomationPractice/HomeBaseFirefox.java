	...
	public static WebDriver driver; //We create at class level.. so Static Object can be accessed anywhere.  
	   ...
	   public static WebDriver Edriver;
		...
		public void setup() {
			...
			Ex = new WebDriverWait(fdriver, 15);  //This is what we use for Explicit Wait. This has a driver parameter and the timer parameter.
			//driver1 = new EdgeDriver();
			 Fxx = new FluentWait(fdriver)
		...
		public void BrowserConfig()  {
			...
			fdriver.manage().window().maximize(); //We maximize or change browser based on our preference.
		}
		...
		public void BrowserClosing() throws InterruptedException {
			...
			fdriver.close();// We close the browser
		...
		public void terminate() {
			fdriver.quit(); // We close the instance and terminate the session. It will erase all the cache memory and make our next execution better.
		}
}
